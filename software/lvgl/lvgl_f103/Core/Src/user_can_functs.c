...
void CAN_receive_init(void) {
	...
	sFilterConfig.FilterIdHigh = 0; ///*((0x04210031  << 5)  | (0x04210031  >> (32 - 5))) & 0xFFFF;*/(0x04210031 >> 13);
	sFilterConfig.FilterIdLow = 0; //(0x04210031 & 0X1FFF) << 3;//(0x04210031 >> (11 - 3)) & 0xFFF8;//(0x04210031 >> 13);
	sFilterConfig.FilterMaskIdHigh = 0; //0xFFFF;//(((uint16_t)0x0FFFffFF  << 5)  | (0x04210031  >> (32 - 5))) & 0xFFFF;
