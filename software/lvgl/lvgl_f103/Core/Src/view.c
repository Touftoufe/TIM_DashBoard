...
void BuildPages()
{
    ...
    lv_style_set_text_color(&style_Label_speed, lv_color_hex(129 * 256 * 256 + 172 * 256 + 255));
    ...
    lv_style_set_text_color(&style_Label_km_h, lv_color_hex(129 * 256 * 256 + 172 * 256 + 255));
    ...
    lv_style_set_text_color(&style_Label_cmd, lv_color_hex(129 * 256 * 256 + 172 * 256 + 255));
