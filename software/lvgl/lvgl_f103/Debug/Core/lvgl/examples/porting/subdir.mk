...
Core/lvgl/examples/porting/%.o: ../Core/lvgl/examples/porting/%.c Core/lvgl/examples/porting/subdir.mk
...
clean-Core-2f-lvgl-2f-examples-2f-porting:
	-$(RM) ./Core/lvgl/examples/porting/lv_port_disp_template.d ./Core/lvgl/examples/porting/lv_port_disp_template.o ./Core/lvgl/examples/porting/lv_port_fs_template.d ./Core/lvgl/examples/porting/lv_port_fs_template.o ./Core/lvgl/examples/porting/lv_port_indev_template.d ./Core/lvgl/examples/porting/lv_port_indev_template.o
