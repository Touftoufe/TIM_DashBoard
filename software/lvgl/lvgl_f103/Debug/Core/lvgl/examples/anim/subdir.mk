...
Core/lvgl/examples/anim/%.o: ../Core/lvgl/examples/anim/%.c Core/lvgl/examples/anim/subdir.mk
...
clean-Core-2f-lvgl-2f-examples-2f-anim:
	-$(RM) ./Core/lvgl/examples/anim/lv_example_anim_1.d ./Core/lvgl/examples/anim/lv_example_anim_1.o ./Core/lvgl/examples/anim/lv_example_anim_2.d ./Core/lvgl/examples/anim/lv_example_anim_2.o ./Core/lvgl/examples/anim/lv_example_anim_3.d ./Core/lvgl/examples/anim/lv_example_anim_3.o ./Core/lvgl/examples/anim/lv_example_anim_timeline_1.d ./Core/lvgl/examples/anim/lv_example_anim_timeline_1.o
