...
Core/lvgl/tests/src/test_fonts/%.o: ../Core/lvgl/tests/src/test_fonts/%.c Core/lvgl/tests/src/test_fonts/subdir.mk
...
clean-Core-2f-lvgl-2f-tests-2f-src-2f-test_fonts:
	-$(RM) ./Core/lvgl/tests/src/test_fonts/font_1.d ./Core/lvgl/tests/src/test_fonts/font_1.o ./Core/lvgl/tests/src/test_fonts/font_2.d ./Core/lvgl/tests/src/test_fonts/font_2.o ./Core/lvgl/tests/src/test_fonts/font_3.d ./Core/lvgl/tests/src/test_fonts/font_3.o
